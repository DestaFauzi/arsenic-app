    ...
    <nav class="mt-4">
        <div class="space-y-1" :class="{ 'px-4': sidebarOpen, 'px-2': !sidebarOpen }">
            ...
            @if (auth()->user()->can('manage_users') || auth()->user()->can('manage_roles'))
                <div x-data="{ open: {{ request()->routeIs('project-types.*') ? 'true' : 'false' }} }"
                    ...
                    <button @click="open = !open"
                        class="flex items-center w-full rounded-lg transition-colors duration-200 group text-arsenic-light hover:bg-arsenic-dark"
                        :class="{
                        ...
                        <span x-show="sidebarOpen" class="ml-3">Access Controll</span>
                    ...
                    <div x-show="open && sidebarOpen" x-transition class="ml-6 mt-2 space-y-1">
                        ...
                        @can('manage_users')
                            <a href="{{ route('users.index') }}"
                                class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors duration-200 text-arsenic-light {{ request()->routeIs('users.*') ? 'bg-arsenic-accent text-arsenic-dark' : 'hover:bg-arsenic-dark' }}">
                        ...
                        @can('manage_roles')
                            <a href="{{ route('roles.index') }}"
                                class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors duration-200 text-arsenic-light {{ request()->routeIs('roles.*') ? 'bg-arsenic-accent text-arsenic-dark' : 'hover:bg-arsenic-dark' }}">
                                <svg class="w-4 h-4 flex-shrink-0 mr-3" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div x-data="{ open: {{ request()->routeIs('project-types.*') ? 'true' : 'false' }} }"
                    ...
                    <div x-show="open && sidebarOpen" x-transition class="ml-6 mt-2 space-y-1">
                        ...
                        <a href="{{ route('project-types.index') }}"
                            class="flex items-center px-3 py-2 text-sm rounded-lg transition-colors duration-200 text-arsenic-light {{ request()->routeIs('project-types.*') ? 'bg-arsenic-accent text-arsenic-dark' : 'hover:bg-arsenic-dark' }}">
                            <svg class="w-4 h-4 flex-shrink-0 mr-3" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
